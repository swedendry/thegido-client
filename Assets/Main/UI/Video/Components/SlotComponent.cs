...
//	public class SlotComponent : SlotComponent<YoutubeViewModel>
//	{
...
//			video_button.onClick.AddListener(() => ClickSlot());
//		}

//		private void OnDestroy()
//		{
//			video_button?.onClick.RemoveListener(() => ClickSlot());
//		}
...
//			var texture = DownloadHandlerTexture.GetContent(www);
//			video_button.image.sprite = Sprite.Create(texture, new Rect(0f, 0f, texture.width, texture.height), Vector2.zero);
//		}
//	}
//}